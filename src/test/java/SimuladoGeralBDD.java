...
public class SimuladoGeralBDD {
	...
	public void euClicoNoItemDeMenuSimuladoGeral() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^Eu sou redirecionado para pagina de simulados sem agrupamento$")
	public void euSouRedirecionadoParaPaginaDeSimuladosSemAgrupamento() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
