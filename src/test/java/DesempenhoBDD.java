...
public class DesempenhoBDD {
	...
	public void euClicoNoItemDeMenuDesempenho() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}

	@Then("^Eu sou redirecionado para pagina de Desempenho$")
	public void euSouRedirecionadoParaPaginaDeDesempenho() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	    throw new PendingException();
	}
